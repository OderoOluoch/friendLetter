    ...
    public static void main(String[] args) {
        ...
        get("photos",(request,response)->
            "<!DOCTYPE html>" +
                    ...
                    "<ul>" +
                    "<li><img src='/images/one.jpg' alt='A photo of a mountain range.'/></li>" +
                    "<li><img src='/images/two.jpg' alt='A photo of a swamp.'/></li>" +
                    "<li><img src='/images/three.jpg' alt='A photo of a swamp.'/></li>" +
                    "</ul>" +
                    "</body>" +
                    "</html>"
        );
